                        ...
                        <div className="mt-10 mb-32 md:mb-0">
                           ...
                           <div className="text-center my-14">
                              <span className="text-center">
                                 <Link to={product.path} title="Link to view all products" className="px-10 py-5 rounded-4xl font-poppins font-semibold text-white uppercase bg-primaryBlue hover:bg-primaryGreen transition-all">See all products</Link>
                              </span>
                           </div>
                           <div className="mt-10 text-center">
                              <a href="mailto:info@metricproducts.com" title="Contact us email on cups and underware products page" className="uppercase font-poppins font-semibold text-white bg-primaryGreen hover:bg-primaryBlue transition-all rounded-3xl px-5 py-2" accessKey="cupAndUnderwareContact">contact us</a>
                           </div>
                        </div>
                     </div>
                  ))
